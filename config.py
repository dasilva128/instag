...
class Config:
    ...
    STATUS = set(int(x) for x in os.environ.get("S", "0").split())
    L = Instaloader()
...
You can also send a post link to download the post or video.
...
/fans <username> - Get a list of followees who follow back the given username. If no username given, your list will be retrieved.

/notfollowing <username> - Get a list of followees who are not following back the given username.
...
This is a bot of [{}](https://www.instagram.com/{}) to manage their Instagram account.
